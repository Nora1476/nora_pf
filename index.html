  ...
  <body>
    <div id="wrap">
      ...
      <main>
        ...
        <div class="sec sec2">
          <div class="sec_inner">
            <div class="tit_wrap"><h2>About</h2></div>
        ...
        <div class="sec sec3">
          <div class="sec_inner">
            <div class="tit_wrap"><h2>CERTIFICATION</h2></div>
        ...
        <div class="sec sec4">
          <div class="sec_inner">
            <div class="tit_wrap"><h2>COMMENT</h2></div>
        ...
        <div class="sec sec5">
          <div class="sec_inner">
            <div class="tit_wrap"><h2>HERE</h2></div>
            ...
            <div class="review" data-aos="fade-left">
              <div class="r1">
                ...
                <p>
                  견적을 보러 오시는 순간도, 다른 견적을 부탁한 곳들과 다르게 집 모든 곳을 꼼꼼히 체크하셨고, 견적 미팅을 한 날짜, 공사가 진행되면서 생긴 작은 문제점들을 처리하는 과정, 그리고 사후
                  문제 처리까지, 모든 것이 잡음없이 잘 진행이 되었습니다.
                </p>
                <p>
                  몇년만 지내다가 옮겨갈 예정으로 한 공사이지만, 더 있고 싶을 정도로 모든 가족들의 만족도가 높습니다. 제가 느낀 점은 다른 분들께도 자신있게 추천해드릴 수 있다입니다. 고민 되시는
                  분들께서는 한번 만나 뵙고 이야기를.....
                </p>
              </div>
              <div class="r2">
